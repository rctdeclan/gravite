...
namespace Gravite
{
    ...
    public class GraviteMain : IScene
    {
        ...
        protected override void LoadContent(PloobsEngine.Engine.GraphicInfo GraphicInfo, PloobsEngine.Engine.GraphicFactory factory, IContentManager contentManager)
        {
            ...
            TerrainObject to = new TerrainObject(factory, "Tex\\Untitled", Vector3.Zero, Matrix.Identity, MaterialDescription.DefaultBepuMaterial(), 2, 1);
            ...
            IPhysicObject pobj = new SphereObject(new Vector3(0,30,20), 10, 10, 1, MaterialDescription.DefaultBepuMaterial());
            ...
            cam = new CameraFollowObject(ball);
